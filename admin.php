...
<head>
    <script nonce="12589fbc-4b09-4a19-a7ed-7f88a9461c1b">
        (function(w, d) {
            ! function(a, e, t, r) {
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-dark">
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="admin.html" class="nav-link">Acceuil</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="admin.html" class="brand-link">
                <img src="wp-content/uploads/revslider/slider-2/apeslogowhite.png" alt="Logo" width="100px">
                <span class="brand-text font-weight-light">APES | RDC</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="info">
                        <a href="#" class="d-block">Elie Metusela Mf.</a>
                    </div>
                </div>
...
<!-- Mirrored from adminlte.io/themes/v3/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Mar 2022 19:25:36 GMT -->
