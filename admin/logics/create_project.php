              ...
              <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form method="POST" class="forms-sample" enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="exampleInputName1">Titre du projet</label>
                        <input name="project_name" type="text" required="required" class="form-control" placeholder="Titre">
                      </div>
                      <div class="form-group">
                        <label for="exampleTextarea1">Description du projet</label>
                        <textarea name="project_content" required="required" class="form-control" id="exampleTextarea1" rows="10" placeholder="Détails du projets"></textarea>
                      </div>
                      <div class="col-md-12 row">
                        <div class="col-md-6 form-group">
                          <label for="exampleTextarea1">Les sponsors</label>
                          <textarea name="project_sponsor" required="required" class="form-control" rows="1" placeholder="Ex: WarChild Holland,UNICEF"></textarea>
                        </div>
                        <div class="col-md-6 form-group">
                          <label for="exampleTextarea1">Zone d'execution et Date</label>
                          <textarea name="project_zone" required="required" class="form-control" rows="1" placeholder="Kalehe, 2019"></textarea>
                        </div>
                      </div>
                      <div class="col-md-12 row">
                        <div class="col-md-6 form-group">
                        ...
                        <div class="col-md-6 form-group">
                          ...
                          <div class="select">
                            <select required="required" name="project_status" id="">
                ...
                <?php elseif($_SESSION['role'] != "full"): ?>
                  <div class="alert alert-danger alert-dismissible">
                    Vous ne pouvez pas créer de projet, cette option est unique réservée aux administrateurs avec toutes les autorisations. 
