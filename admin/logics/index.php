        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="stage_show.php">
              ...
              <span class="menu-title">Stagiaire</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="create_post.php">
              <i class="icon-columns menu-icon"></i>
              <span class="menu-title">Creer un post</span>
            </a>
          </li>
          <li class="nav-item">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">Tous les systèmes fonctionnent correctement ! Vous as <span class="text-primary">3 Notifications!</span></h6>
                </div>
              ...
              <div class="row">
                <div class="col-md-3 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?= count($rowcount) ?></p>
                      <p>10.00% (30 days)</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-3 mb-4 stretch-card transparent">
                  <div class="card card-light-blue">
                    <div class="card-body">
                      <p class="mb-4">Totale partenaires</p>
                        ...
                        <table id="example" class="display expandable-table" style="width:100%">
                          ...
                          <?php foreach($stages as $stage): ?>
                                <tr>
                                    ...
                                    <td><?= $stage->domain ?></td>
                                    <td><?= $stage->niveau ?></td>
                                    <td><a href="#"><?= $stage->files_url ?></a></td>
                                    <td><a href="#"><?= $stage->files_url2 ?></a></td>
                                    <td><a href="#"><?= $stage->files_url3 ?></a></td>
                                </tr>
                            <?php endforeach ?>
                          </tbody>
                      </table>
