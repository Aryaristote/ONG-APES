            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                  <div class="col-md-12" style="margin-bottom: 20px">
                    <div class="card">
                    <div class="card-body">
                      <h5 class="card-title"><?= $offre->post_name ?></h5>
                      <p class="card-text"><?= $offre->post_description ?></p>
                    </div>
                    <ul class="list-group list-group-flush">
                      <li class="list-group-item"><b>Zone: </b><?= $offre->post_zone ?></li>
                      <li class="list-group-item"><b>Nombres: </b><?= $offre->post_number ?></li>
                      <li class="list-group-item"><b>Debut: </b><?= $offre->start_date ?></li>
                    ...
                    <div class="card-body">
                      <div class="col-md-12">
                      <form method="post" class="row text-right">
