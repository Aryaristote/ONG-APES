...
<!-- Mirrored from bootstrapdash.com/demo/skydash-free/template/pages/samples/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Jul 2022 10:30:27 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="utf-8">
            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" method="POST">
                <div class="form-group">
                  <input name="name" type="text" class="form-control form-control-lg" id="exampleInputUsername1" placeholder="Username">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <input name="password_confirm" type="password" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="Password">
                </div>
                <div class="mb-4">
