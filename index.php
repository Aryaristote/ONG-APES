...
<head>
	...
	<link rel="stylesheet" href="iconsbar.css">
					...
					<div class="col-sm-4">
						...
						<ul class="list list-unstyled mb-0">
							<li class="text-4 mb-4">
								<strong class="font-weight-semibold text-color-dark">Année: </strong>
								2016-2017
							</li>
							<li class="text-4 mb-4">
								<strong class="font-weight-semibold text-color-dark">Durée: </strong>
								1 an
							</li>
						</ul>
					</div>
						...
						<blockquote class="custom-blockquote-style-1 m-0 pt-1 pb-2">
							<div class="custom-read-more-style-1">
								...
								<div class="readmore-button-wrapper d-none">
									<a href="https://missioneast.org/en/node/37" class="text-decoration-none">
					...
					<div class="col-sm-5">
						<blockquote class="custom-blockquote-style-1 m-0 pt-1 pb-2">
							<div class="custom-read-more-style-1">
								...
								<div class="readmore-button-wrapper d-none">
									<a href="https://www.unfpa.org/fr" class="text-decoration-none">
										En savoir plus sur le sponsor
									</a>
								</div>
							</div>
