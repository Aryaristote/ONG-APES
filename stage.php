...
<body id="page-top" class="" >
																...
																<label class="card">
																	...
																	<div class="card__body">
																		<header class="card__body-header">
																			<h5 class="card__body-header-title">Diplômé d'Etat</h5>
																		</header>
																	</div>
																</label>
																<label class="card">
																	...
																	<div class="card__body">
																		<header class="card__body-header">
																			<h5 class="card__body-header-title">Grade</h5>
																		</header>
																	</div>
																</label>
																<label class="card">
																	...
																	<div class="card__body">
																		<header class="card__body-header">
																			<h5 class="card__body-header-title">License</h5>
																		</header>
																	</div>
																</label>
																<label class="card">
																	...
																	<div class="card__body">
																		<header class="card__body-header">
																			<h5 class="card__body-header-title">Master</h5>
																		</header>
																	</div>
																</label>
																<label class="card">
																	...
																	<div class="card__body">
																		<header class="card__body-header">
																			<h5 class="card__body-header-title">Plus +</h5>
																		</header>
																	</div>
																</label>
															</div>
										...
										<div class="u-layout-col">
											<div class="u-container-style u-layout-cell u-right-cell u-layout-cell-6">
												<div class="u-container-layout u-container-layout-6">
													...
													<div class="btn-block">
														<div class="button button-mat btn--5 input-group mb-3 px-2 py-2 rounded-pill bg-white shadow-sm">
															<input id="upload" type="file" onchange="readURL(this);" class="psuedo-text form-control border-0">
															<label id="upload-label" for="upload" class="psuedo-text font-weight-light text-muted">TÉLÉCHARGER</label>
														</div>
													</div><br>
												...
												<div class="u-container-layout u-container-layout-6">
													<h3 class="u-text u-text-default u-text-12" style="color: #838383;">
														JOINDRE VOTRE CV (WORD OU PDF) 
													</h3>

													<div class="btn-block">
														<div class="button button-mat btn--5 input-group mb-3 px-2 py-2 rounded-pill bg-white shadow-sm">
															<input id="upload" type="file" onchange="readURL(this);" class="psuedo-text form-control border-0">
															<label id="upload-label" for="upload" class="psuedo-text font-weight-light text-muted">JOINDRE</label>
														</div>
													</div><br>
													<div class="image-area2 mt-4"><img id="imageResult" src="#" alt="" class="img-fluid rounded shadow-sm mx-auto d-block"></div>
												</div>
											</div>
											...
											<div class="u-container-style u-layout-cell u-right-cell u-size-40 u-layout-cell-6">
												<div class="u-container-layout u-container-layout-6">
													<h3 class="u-text u-text-default u-text-12" style="color: #838383;">
														AJOUTER UNE PIECES D'INDENTITE 
													</h3>
												...
												<div class="u-container-layout u-container-layout-6">
													<h3 class="u-text u-text-default u-text-12" style="color: #838383;">
														JOINDRE UNE LETTRE DE MOTIVATION (word ou PDF)
													</h3>
	...
	<script src="js_preview/jquery-3.3.1.slim.min.js"></script>
	<script src="js_preview/bootstrap.bundle.min.js"></script>
	<script>
