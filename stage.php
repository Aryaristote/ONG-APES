														...
														<form method="post" enctype="multipart/form-data" class="col-md-12 u-clearfix u-form-spacing-10 u-form-vertical u-inner-form">
															<div class="col-md-6">
																<div class="u-form-group u-form-name">
																	<h5>Nom complet * </h5>
																	<input name="name" type="text" placeholder="Ex: Kalume Ernest Aristote" class="u-input u-input-rectangle u-white">
																</div>
																<div class="u-form-group u-form-name">
																	<h5>Nationalité * </h5>
																	<input name="country" type="text" placeholder="Ex: Congolaise" class="u-input u-input-rectangle u-white">
																</div>
																<div class="u-form-group u-form-name">
																	<h5>Residence actuelle * </h5>
																	<input name="location" type="text" placeholder="Ex: Bukavu" class="u-input u-input-rectangle u-white">
																</div>
																<div class="u-form-group u-form-name">
																...
																<div class="col-md-12 u-form-group u-form-name" style="padding: 0 10px;margin: 0;">
																	<div class="col-md-8" style="padding: 0;margin: 0 25px 0 0;">
																		...
																		<input type="text" placeholder="Ex: Géologie" name="domain" class="u-input u-input-rectangle u-white">
																	</div>
																	<div class="col-md-3" style="padding: 0;margin: 0;">
																		<h5>Experience * </h5>
																		<input type="number" placeholder="Ex: 5" name="experience" class="u-input u-input-rectangle u-white">
																	</div>
																</div>
															</div>
															<div class="col-md-6">
